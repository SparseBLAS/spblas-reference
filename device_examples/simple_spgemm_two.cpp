...
int main(int argc, char** argv) {
  ...
  COPY((void**) da_values, a_values.data(), sizeof(float) * nnz, H2D);
  ...
  float* dc_values;
  int* dc_colind;
  MALLOC((void**) &dc_values, info.result_nnz() * sizeof(float));
  MALLOC((void**) &dc_colind, info.result_nnz() * sizeof(int));
