...
int main(int argc, char** argv) {
  ...
  std::cout << "\n\t#################################################################################"
            ...
            << "\n\t###"
            << "\n\t### with "
            << "\n\t### A in CSR format of size (" << m <<", " << k << ") with nnz = " << nnz
            << "\n\t### X, a dense matrix in rowmajor format of size (" << k <<", " << n << ")"
            << "\n\t### Y, a dense matrix in rowmajor format of size (" << m <<", " << n << ")"
            << "\n\t### using float and spblas::index_t (size = " << sizeof(spblas::index_t) << " bytes)"
            << "\n\t#################################################################################" 
            << std::endl;
