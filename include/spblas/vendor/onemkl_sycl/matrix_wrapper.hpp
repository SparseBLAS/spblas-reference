...
oneapi::mkl::sparse::matrix_handle_t get_matrix_handle(sycl::queue &q, A&& a_base)
{
...
template<matrix A>
    requires __detail::has_csr_base<A>
oneapi::mkl::sparse::matrix_handle_t get_matrix_handle(sycl::queue &q, A&& a_base, oneapi::mkl::sparse::matrix_handle_t info_a_handle)
{
  oneapi::mkl::sparse::matrix_handle_t a_handle = nullptr;
