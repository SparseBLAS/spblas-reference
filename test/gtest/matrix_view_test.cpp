...
TEST(Tag, Conjugate) {
  ...
  StaticAssertTypeEq<decltype(conjugate(t)),
                     legacy_pattern<temp&, std::true_type, std::false_type,
                                    diag::explicit_diag, uplo::full>>();
  StaticAssertTypeEq<decltype(conjugate(conjugate(t))),
                     legacy_pattern<temp&, std::false_type, std::false_type,
                                    diag::explicit_diag, uplo::full>>();
...
TEST(Tag, Tranpose) {
  ...
  StaticAssertTypeEq<decltype(transpose(t)),
                     legacy_pattern<temp&, std::false_type, std::true_type,
                                    diag::explicit_diag, uplo::full>>();
